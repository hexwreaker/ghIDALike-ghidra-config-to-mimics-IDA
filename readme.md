...
In ghidra project -> Edit -> Theme -> Import -> select your theme file

#### Keyboard shortcuts

In ghidra CodeBrowser -> Edit -> ToolOptions -> "Key Bindings" -> Import -> select your .kbxml file

## Contribution

Feel free to propose improvements of this repo in the issues panel !
I will be glad to add your own configuration versions.
